...
func TestMaster(t *testing.T) {
	...
	Headers.Add("referer", "https://www.bilibili.com/video/BV18K4y1x7ZM?spm_id_from=333.851.b_7265706f7274466972737431.8")
	...
	client := &http.Client{}
	master, err := NewMaster(rawURL, thread, addr, client)
	if err != nil {
		fmt.Println(err)
		return
	}
